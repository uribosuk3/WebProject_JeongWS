...
<head>
    ...
    <!-- Google Fonts -->
    <link href="https://fonts.googleapis.com/css?family=Raleway:300,400,600,600i,700,800" rel="stylesheet">
    <!-- Font Awesome -->
            ...
            <div class="row">
                <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                    <div class="error-block">
                        ...
                        <a href="index.html" class="btn btn-default btn-lg">Go back to the main page</a> </div>
                    <!-- /.error block -->
                </div>
            </div>
        </div>
